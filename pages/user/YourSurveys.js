...
exports.default = exports.YourSurveys = void 0;
...
class YourSurveys extends _react.Component {
  constructor(props) {
    super(props);
    ...
    (0, _defineProperty2.default)(this, "callApi", async () => {
      const response = await fetch('/admin/userSurveyList/' + this.state.user.id);
  ...
  render() {
    ...
    const renderItems = this.state.data.filter(i => {
      ...
      return /*#__PURE__*/_react.default.createElement("tr", {
        key: index
      }, /*#__PURE__*/_react.default.createElement("td", null, index + 1), /*#__PURE__*/_react.default.createElement("td", null, i.title), /*#__PURE__*/_react.default.createElement("td", null, i.reward), /*#__PURE__*/_react.default.createElement("td", null, (0, _moment.default)(i.updated_at).format("DD MMMM  YYYY")));
    });
    const pageNumbers = [];
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Header.default, null), !this.state.loading ? /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: "heading"
    }, "Your Survey"), /*#__PURE__*/_react.default.createElement("div", {
      className: "btn-pag"
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: "perPage"
    ...
    }, /*#__PURE__*/_react.default.createElement("thead", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, "Sl no."), /*#__PURE__*/_react.default.createElement("td", null, "Survey Title"), /*#__PURE__*/_react.default.createElement("td", null, "Reward"), /*#__PURE__*/_react.default.createElement("td", null, "Date"))), /*#__PURE__*/_react.default.createElement("tbody", null, this.state.loading ? /*#__PURE__*/_react.default.createElement("tr", {
      className: "loading"
...
exports.YourSurveys = YourSurveys;
var _default = YourSurveys;
