...
class CashbackHistory extends _react.Component {
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "callApi", async () => {
      const response = await fetch('/admin/userCashback/' + this.state.user.id);
  ...
  render() {
    ...
    const renderItems = this.state.data.filter(i => {
      if (this.state.search == null) return i;else if (i.store.toLowerCase().includes(this.state.search.toLowerCase())) {
        return i;
      }
    }).slice(indexOfFirstItem, indexOfLastItem).map((i, index) => {
      return /*#__PURE__*/_react.default.createElement("tr", {
        key: index
      }, /*#__PURE__*/_react.default.createElement("td", null, index + 1), /*#__PURE__*/_react.default.createElement("td", null, i.store), /*#__PURE__*/_react.default.createElement("td", null, i.payout), /*#__PURE__*/_react.default.createElement("td", null, (0, _moment.default)(i.date).format("DD MMMM  YYYY")));
    });
    const pageNumbers = [];
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Header.default, null), !this.state.loading ? /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: "heading"
    }, "Your Cashback"), /*#__PURE__*/_react.default.createElement("div", {
      className: "btn-pag"
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: "perPage"
    ...
    }, /*#__PURE__*/_react.default.createElement("thead", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, "Sl no."), /*#__PURE__*/_react.default.createElement("td", null, "Store"), /*#__PURE__*/_react.default.createElement("td", null, "Payout"), /*#__PURE__*/_react.default.createElement("td", null, "Shopping Date"))), /*#__PURE__*/_react.default.createElement("tbody", null, this.state.loading ? /*#__PURE__*/_react.default.createElement("tr", {
      className: "loading"
