...
exports.default = exports.UpdateSurvey = void 0;
...
class UpdateSurvey extends _react.Component {
  constructor(props) {
    super(props);
    (0, _defineProperty2.default)(this, "callApi", async () => {
      ...
      const response = await fetch('/admin/getSurvey/' + id);
      const body = await response.json();
      if (response.status !== 200) throw Error(body.message);
      body.data.results.forEach(i => {
      ...
      this.setState({
        ...
        title: body.questions.title,
        status: body.questions.status,
        reward: body.questions.reward,
        questions: JSON.parse(body.questions.questions),
        questionOptions: this.state.questionOptions,
        count: new Array(JSON.parse(body.questions.questions).length).fill('blank'),
        loading: false
      });
    });
    ...
    (0, _defineProperty2.default)(this, "addHandler", e => {
      ...
      _axios.default.post('/admin/updateSurvey', data).catch(err => func.printError(err)).then(res => {
        if (res.data.success) {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Header.default, null), !this.state.loading ? /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: "casleyBtn",
      type: "submit"
    }, "Update Survey") : null)))) : /*#__PURE__*/_react.default.createElement("div", {
      className: "loading"
